# Game Reconstruction Pipeline Documentation

**Stage: POC — building now.** Challenges SoccerNet GSR on cost/efficiency. Scoring and matchmaking are **thesis scope — separate systems**. Event detection is **deferred**.

| Document | Description |
|----------|-------------|
| [overview.md](overview.md) | Pipeline overview (POC) — vs SoccerNet, eliminated/conditional steps |
