...
| [decisions/log.md](decisions/log.md) | Decisiones (ADR) |
| [research/](research/) | Síntesis, bibliografía y papers por tema |
| [glosario.md](glosario.md) | Términos |
| [roadmap.md](roadmap.md) | Plan + estado |
